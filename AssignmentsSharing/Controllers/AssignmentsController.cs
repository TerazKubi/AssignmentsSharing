    ...
    public class AssignmentsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Assignments != null ? 
                          ...
                          Problem("Entity set 'DataContext.Assignments'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Label,Description,TimeCost,Priority")] Assignment assignment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Id,Label,Description,TimeCost,Priority")] Assignment assignment)
        {
            if (id != assignment.Id)
            {
                return NotFound();
