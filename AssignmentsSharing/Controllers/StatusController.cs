    ...
    public class StatusController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Statuses != null ? 
                          ...
                          Problem("Entity set 'DataContext.Statuses'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,StatusType,OccuranceTime")] Status status)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Id,StatusType,OccuranceTime")] Status status)
        {
            if (id != status.Id)
            {
                return NotFound();
