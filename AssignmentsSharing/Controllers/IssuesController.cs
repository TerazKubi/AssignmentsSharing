...
namespace AssignmentsSharing.Controllers
{
    public class IssuesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Description,Label")] Issue issue)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Id,Description,Label")] Issue issue)
        {
            if (id != issue.Id)
            {
                return NotFound();
